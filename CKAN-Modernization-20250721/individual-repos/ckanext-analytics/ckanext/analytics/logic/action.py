...
def _log_event(event_type, dataset_id=None, resource_id=None, event_data=None, user_id=None):
...
# Wrapper functions for original actions
...
def _log_event_with_cache_invalidation(event_type, dataset_id=None, resource_id=None, event_data=None, user_id=None):
